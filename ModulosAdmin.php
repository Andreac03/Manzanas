...
<body>
    ...
    <main>
        ...
        <br>
        <center>
        <a href="TabServ.php"><button class="perfil">Citas Agendadas</button></a>
        <a href="tabUsua.php"><button class="perfil">Perfiles de Usuarios</button></a>
        </center>
    </main>
    <footer>
        <center>
